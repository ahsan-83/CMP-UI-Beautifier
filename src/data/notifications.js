export const NOTIFICATIONS = [
  {
    ...
    description:
      "You have a Waiting for Delivery Customer Resource Order ID: 20260315-NDC-00075-516.",
    hoursAgo: 18,
    read: false,
  },
  {
    ...
    description:
      "New Resource Order arrived from customer Rajdhani Unnayan Kartipakkha (RAJUK) (with attachment)",
    hoursAgo: 18,
    read: false,
  },
  {
  ...
  },
  {
    ...
    title: "New Waiting for Delivery Customer Resource Order arrived",
    description:
      "You have a Waiting for Delivery Customer Resource Order ID: 20260311-NDC-00075-492.",
    hoursAgo: 21,
    read: false,
  },
  {
  ...
  },
  {
    ...
    description:
      "Your contract NDC-00075 is due for renewal in 30 days. Please review and take action.",
    hoursAgo: 30,
    read: true,
  },
];
